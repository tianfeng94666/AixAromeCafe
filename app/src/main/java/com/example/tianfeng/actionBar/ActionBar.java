 ...
 */
package com.example.tianfeng.actionBar;
...
public class ActionBar extends LinearLayout {
    ...
    public ActionBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        int layoutID = R.layout.gd_action_bar_normal;
...
//                    mHomeButton.setOnClickListener(mClickHandler);
                    ...
                    leftImageButton = (ImageView) findViewById(R.id.gd_action_bar_home_item);
                    leftImageButton.setImageDrawable(mHomeDrawable);
    ...
    public ActionBarItem addItem(ActionBarItem item, int itemId) {
        ...
        if (item != null) {
            ...
            if (mDividerDrawable != null) {
                ...
                final LayoutParams lp = new LayoutParams(dividerWidth, LayoutParams.FILL_PARENT);
